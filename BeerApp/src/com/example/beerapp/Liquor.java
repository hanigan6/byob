...
public class Liquor extends Activity implements OnClickListener, OnItemSelectedListener, OnEditorActionListener {
	...
	private void populate () {
		Cursor cursor;
		list = (ListView) findViewById(R.id.liquor_list);
	...
	private void showLiquor () throws IOException {
		if (isOnline()) {
		Log.i("sB", "0");
	...
	public void onClick(View v) {
		...
		case R.id.add_beverage_button:
			...
			if (nametext.equals("")) {
				...
				new AlertDialog.Builder(Liquor.this)
	            .setTitle("Liquor already exists")
	            .setNeutralButton("OK",
	                new DialogInterface.OnClickListener() {
	                    public void onClick(
	                            DialogInterface dialog,
			...
			startActivity(new Intent(this, Liquor.class));
			break;
		}
