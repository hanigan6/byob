...
public class Wine extends Activity implements OnClickListener, OnItemSelectedListener, OnEditorActionListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		View btnAddWine = (Button) findViewById(R.id.add_wine_button);
	...
	private void populate () {
		Cursor cursor;
		list = (ListView) findViewById(R.id.wine_list);
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case R.id.add_wine_button:
			startActivity(new Intent(this, AddWine.class));
			break;
		case R.id.add_beverage_button:
			...
			startActivity(new Intent(this, Wine.class));
			break;
		}
